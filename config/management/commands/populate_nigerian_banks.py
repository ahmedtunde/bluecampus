# management/commands/populate_nigerian_banks.py
from django.core.management.base import BaseCommand
from expense_tracker.app.users.models import BankList

class Command(BaseCommand):
    help = 'Populate Nigerian banks data'

    def handle(self, *args, **kwargs):
        # Clear existing data (optional)
        BankList.objects.all().delete()

        # Define the bank data as a dictionary
        bank_data = {
    ...
    "unilorin Microfinance Bank": "090341"
        ...
        for name, code in bank_data.items():
            BankList.objects.create(name=name, bank_code=code)

        self.stdout.write(self.style.SUCCESS('Successfully populated Nigerian banks data.'))
